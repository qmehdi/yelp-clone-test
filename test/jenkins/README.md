2-8-2019
Discoveries trying to run jenkins slave with this chart.
- After you deploy the chart, you have to go into Jenkins -> Configure System and under the Cloud section, change the kubernetes pod template name to the name of the service account that got created as part of the chart deployment. Get the service account name by running this command 
kubectl get serviceaccounts -n <namespace>
- Create tls secrets as follows:
    kubectl create secret tls digicert-cert --key digicert-key.pem --cert bundle.crt -n jenkins
